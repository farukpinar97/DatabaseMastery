...
namespace DatabaseMastery.DinnerMenuPostgreSQL.Controllers
{
    public class ReviewController : Controller
    {
        ...
        // UI tarafı — Müşteri değerlendirme formu
        [HttpPost]
        public async Task<IActionResult> CreateUserReview(CreateReviewDto createReviewDto)
        {
            createReviewDto.CreatedAt = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc);
            ...
            TempData["ReviewSuccess"] = "Değerlendirmeniz alındı, incelendikten sonra yayınlanacaktır.";
